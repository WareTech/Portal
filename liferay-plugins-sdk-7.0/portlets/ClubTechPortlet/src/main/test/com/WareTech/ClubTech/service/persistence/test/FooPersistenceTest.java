...
package com.WareTech.ClubTech.service.persistence.test;

import com.WareTech.ClubTech.exception.NoSuchFooException;
import com.WareTech.ClubTech.model.Foo;
import com.WareTech.ClubTech.service.FooLocalServiceUtil;
import com.WareTech.ClubTech.service.persistence.FooPersistence;
import com.WareTech.ClubTech.service.persistence.FooUtil;
...
public class FooPersistenceTest {
	...
	protected OrderByComparator<Foo> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("service_Foo", "fooId",
